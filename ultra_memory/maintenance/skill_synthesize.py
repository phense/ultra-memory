...
# --------------------------------------------------------------------------- #
# Slug derivation (fork H — one skill per domain).
# --------------------------------------------------------------------------- #
...
def slugify_domain(domain: str) -> str:
    ...
    # domains onto one skill (the 2026-06-01 review finding). A recursive
    # 'gen-<x>' domain legitimately maps to a distinct 'gen-gen-<x>' slug; residual
    # slugify collisions are caught by the source_domain cross-domain guard in the
